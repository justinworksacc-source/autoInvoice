...
import { ensureAutomationSettings } from "../server/automation-settings.js";
...
async function automationSettings(req, res, session) {
...
export default async function handler(req, res) {
  try {
    ...
    if (req.query?.resource === "automation") {
      return await automationSettings(req, res, session);
    }
